...
function fncGetJSON(_path, _handler) {
	...
	rawFile.onreadystatechange = function() {
		if (rawFile.readyState === 4 && rawFile.status == "200") {
			...
			temp = temp.replaceAll("\":000", "\":0");
			temp = temp.replaceAll("\":00" , "\":0");
			temp = temp.replaceAll("\":01" , "\":1");
			temp = temp.replaceAll("\":02" , "\":2");
			temp = temp.replaceAll("\":03" , "\":3");
			temp = temp.replaceAll("\":04" , "\":4");
			temp = temp.replaceAll("\":05" , "\":5");
			temp = temp.replaceAll("\":06" , "\":6");
			temp = temp.replaceAll("\":07" , "\":7");
			temp = temp.replaceAll("\":08" , "\":8");
			temp = temp.replaceAll("\":09" , "\":9");
			try{
