...
enum _robot_throttle_mode_t{
    ROBOT_THROTTLE_MODE_MANUAL = 0,        //!< Robot throttle is manually set
    ROBOT_THROTTLE_MODE_AUTO               //!< Robot throttle is based direction based
};
typedef uint8_t robot_throttle_mode_t;
...
class TwoWheelRobotClass
{
    ...
    public:
        ...
        //! 
        void setSteeringWheelPosition(float pSteeringWheelPosition);
        ...
        //! 
        //! @brief Set the Throttle Mode object
        //! 
        //! @param pMode Throttle mode
        void setThrottleMode(robot_throttle_mode_t pMode){_throttleMode = pMode;}

        //! 
        //! @brief Get the Throttle Mode object
        //! 
        //! @return robot_throttle_mode_t 
        //! 
        robot_throttle_mode_t getThrottleMode(void){return _throttleMode;}
        ...
        //! 
        virtual void applyDutyCycle(uint16_t pLeftMotorPwm, uint16_t pRightMotorPwm) = 0;
    ...
    protected:
        ...
        //! 
        uint16_t findMotorDutyCycle(float pSteeringWheelPosition);
    ...
    protected:
        ...
        robot_throttle_mode_t _throttleMode;    //!< Throttle mode
